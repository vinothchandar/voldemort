...
_ADMINREQUESTTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='ORPHAN_DATA_PURGE_JOB', index=23, number=25,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
...
_ORPHANDATAPURGEJOBREQUEST = descriptor.Descriptor(
  name='OrphanDataPurgeJobRequest',
  full_name='voldemort.OrphanDataPurgeJobRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='store_name', full_name='voldemort.OrphanDataPurgeJobRequest.store_name', index=0,
...
_ORPHANDATAPURGEJOBRESPONSE = descriptor.Descriptor(
  name='OrphanDataPurgeJobResponse',
  full_name='voldemort.OrphanDataPurgeJobResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='error', full_name='voldemort.OrphanDataPurgeJobResponse.error', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VOLDEMORTADMINREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='orphan_data_purge_job', full_name='voldemort.VoldemortAdminRequest.orphan_data_purge_job', index=24,
...
_ORPHANDATAPURGEJOBRESPONSE.fields_by_name['error'].message_type = voldemort_client_pb2._ERROR
...
_VOLDEMORTADMINREQUEST.fields_by_name['orphan_data_purge_job'].message_type = _ORPHANDATAPURGEJOBREQUEST
...
class OrphanDataPurgeJobRequest(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ORPHANDATAPURGEJOBREQUEST
  
  # @@protoc_insertion_point(class_scope:voldemort.OrphanDataPurgeJobRequest)

class OrphanDataPurgeJobResponse(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ORPHANDATAPURGEJOBRESPONSE
